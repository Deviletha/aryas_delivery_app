...
class _CompletedState extends State<Completed> {
  String? base = "https://hotelaryas.com/basicapi/public/";
  String? UID;
    ...
    if (response != null) {
      setState(() {
        ...
        if (deliveryList != null && deliveryList1 != null) {
          ...
          /// Filter the finalDeliveryList to include only today's items
          finalDeliveryList = finalDeliveryList?.where((item) => item["date"] == currentDate).toList();

          print(finalDeliveryList);
        }
      });
    } else {
    ...
    return SizedBox(
      ...
      child: Shimmer.fromColors(
        ...
        child: ListView.builder(
          itemCount: 7, // Number of shimmering items
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                // Filter items with "status" = 4
                if (finalDeliveryList![index]["status"] == 4) {
                    ...
                    TextButton(
                        onPressed: () {
                          ...
                          double latitude = double.parse(
                              finalDeliveryList![index]["latitude"]);
